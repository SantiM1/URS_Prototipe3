...
} from 'app/mock-api/apps/fases/data';
import { assign, cloneDeep } from 'lodash-es';

@Injectable({ providedIn: 'root' })
export class FasesMockApi {
    ...
    registerHandlers(): void {
        ...
        this._fuseMockApiService
            .onGet('api/apps/fases/products', 300)
            .reply(({ request }) => {
        ...
        // -----------------------------------------------------------------------------------------------------
        this._fuseMockApiService
            .onPatch('api/apps/fases/product')
            .reply(({ request }) => {
        ...
        // -----------------------------------------------------------------------------------------------------
        this._fuseMockApiService
            .onDelete('api/apps/fases/product')
            .reply(({ request }) => {
                // Get the id
                const id = request.params.get('id');
