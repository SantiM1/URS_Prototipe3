...
export class UsuariosMockApi {
    ...
    registerHandlers(): void {
        ...
        this._fuseMockApiService
            .onGet('api/apps/usuarios/categories')
        ...
        // -----------------------------------------------------------------------------------------------------
        this._fuseMockApiService
            .onGet('api/apps/usuarios/brands')
        ...
        // -----------------------------------------------------------------------------------------------------
        this._fuseMockApiService
            .onDelete('api/apps/usuarios/tag')
            .reply(({ request }) => {
                // Get the id
                const id = request.params.get('id');
        ...
        // -----------------------------------------------------------------------------------------------------
        this._fuseMockApiService
            .onGet('api/apps/usuarios/vendors')
