...
} from 'app/mock-api/apps/dispositivos/data';
import { assign, cloneDeep } from 'lodash-es';

@Injectable({ providedIn: 'root' })
export class DispositivosMockApi {
    ...
    registerHandlers(): void {
        ...
        this._fuseMockApiService
            .onGet('api/apps/dispositivos/products', 300)
            .reply(({ request }) => {
        ...
        // -----------------------------------------------------------------------------------------------------
        this._fuseMockApiService
            .onGet('api/apps/dispositivos/product')
            .reply(({ request }) => {
        ...
        // -----------------------------------------------------------------------------------------------------
        this._fuseMockApiService
            .onPost('api/apps/dispositivos/product')
            .reply(() => {
        ...
        // -----------------------------------------------------------------------------------------------------
        this._fuseMockApiService
            .onPatch('api/apps/dispositivos/product')
            .reply(({ request }) => {
        ...
        // -----------------------------------------------------------------------------------------------------
        this._fuseMockApiService
            .onDelete('api/apps/dispositivos/product')
            .reply(({ request }) => {
                // Get the id
                const id = request.params.get('id');
