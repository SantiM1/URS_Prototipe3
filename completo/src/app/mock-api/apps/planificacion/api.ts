...
} from 'app/mock-api/apps/planificacion/data';
import { assign, cloneDeep } from 'lodash-es';

@Injectable({ providedIn: 'root' })
export class PlanificacionMockApi {
    ...
    registerHandlers(): void {
        ...
        this._fuseMockApiService
            .onGet('api/apps/planificacion/products', 300)
            .reply(({ request }) => {
        ...
        // -----------------------------------------------------------------------------------------------------
        this._fuseMockApiService
            .onGet('api/apps/planificacion/product')
            .reply(({ request }) => {
        ...
        // -----------------------------------------------------------------------------------------------------
        this._fuseMockApiService
            .onPost('api/apps/planificacion/product')
            .reply(() => {
        ...
        // -----------------------------------------------------------------------------------------------------
        this._fuseMockApiService
            .onPatch('api/apps/planificacion/product')
            .reply(({ request }) => {
        ...
        // -----------------------------------------------------------------------------------------------------
        this._fuseMockApiService
            .onDelete('api/apps/planificacion/product')
            .reply(({ request }) => {
                // Get the id
                const id = request.params.get('id');
