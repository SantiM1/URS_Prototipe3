...
import { InfoDetalleHogarComponent } from "app/modules/URS/seguimiento-nominal-hogar-cards/informacion-detalle-hogar/info-detalle-hogar.component";

@Component({
    selector: 'cards',
    templateUrl: './seguimiento-nominal-hogar-cards.component.html',
    styles: [
        `
            cards fuse-card {
                margin: 16px;
...
export class SeguimientoNominalHogarCardsComponent implements AfterViewInit {
     ...
     * Constructor
     */
    constructor(private _renderer2: Renderer2, private dialog: MatDialog) {}
    ...
    openViviendaDetalleDialog(): void {
                                   this.dialog.open(InfoDetalleHogarComponent, {
                                     width: '900px', // Adjust width as needed
                                     data: {}, // Pass any data if needed
                                   });
                                 }
