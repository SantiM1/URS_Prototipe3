...
import {
    labelColorDefs,
    labelColors,
} from 'app/modules/URS/portal-servicios/inbox-notification/inbox-notification.constants';
import { UserService } from 'app/modules/URS/portal-servicios/inbox-notification/inbox-notification.service';
import { MailLabel } from 'app/modules/URS/portal-servicios/inbox-notification/inbox-notification.types';
import { debounceTime, take } from 'rxjs';

@Component({
    selector: 'inbox-settings',
...
export class UserSettingsComponent implements OnInit {
    ...
    deleteLabel(id: string): void {
        ...
        this._inboxService.deleteLabel(id).subscribe();
    }
