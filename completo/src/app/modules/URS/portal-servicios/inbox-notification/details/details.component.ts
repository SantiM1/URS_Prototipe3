...
import { labelColorDefs } from 'app/modules/URS/portal-servicios/inbox-notification/inbox-notification.constants';
import { UserService } from 'app/modules/URS/portal-servicios/inbox-notification/inbox-notification.service';
import {
    Mail,
    MailFolder,
    MailLabel,
} from 'app/modules/URS/portal-servicios/inbox-notification/inbox-notification.types';
...
export class UserDetailsComponent implements OnInit, OnDestroy {
    ...
    ngOnInit(): void {
        ...
        this._inboxService.selectedMailChanged
            .pipe(takeUntil(this._unsubscribeAll))
            .subscribe(() => {
