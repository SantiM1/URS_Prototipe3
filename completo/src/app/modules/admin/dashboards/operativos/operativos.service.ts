...
export class InventoryService {
    ...
    getBrands(): Observable<InventoryBrand[]> {
        return this._httpClient
            .get<InventoryBrand[]>('api/apps/usuarios/brands')
            .pipe(
                tap((brands) => {
    ...
    getCategories(): Observable<InventoryCategory[]> {
        return this._httpClient
            .get<InventoryCategory[]>('api/apps/usuarios/categories')
            .pipe(
                tap((categories) => {
    ...
    getTags(): Observable<InventoryTag[]> {
        return this._httpClient
            .get<InventoryTag[]>('api/apps/usuarios/tags')
            .pipe(
                tap((tags) => {
    ...
    createTag(tag: InventoryTag): Observable<InventoryTag> {
        return this.tags$.pipe(
            ...
            switchMap((tags) =>
                this._httpClient
                    .post<InventoryTag>('api/apps/usuarios/tag', {
                        tag,
                    })
                    .pipe(
                        map((newTag) => {
    ...
    updateTag(id: string, tag: InventoryTag): Observable<InventoryTag> {
        return this.tags$.pipe(
            ...
            switchMap((tags) =>
                this._httpClient
                    .patch<InventoryTag>('api/apps/usuarios/tag', {
                        id,
                        tag,
                    })
                    .pipe(
    ...
    getVendors(): Observable<InventoryVendor[]> {
        return this._httpClient
            .get<InventoryVendor[]>('api/apps/usuarios/vendors')
            .pipe(
                tap((vendors) => {
