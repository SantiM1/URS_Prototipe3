...
import { AplicacionesService } from 'app/modules/admin/dashboards/sistema/aplicaciones.service';
import {
    SistemaPagination,
    AplicacionesProduct,
    ...
    implements OnInit, AfterViewInit, OnDestroy
{
    ...
    products$: Observable<AplicacionesProduct[]>;
   
    flashMessage: 'success' | 'error' | null = null;
    isLoading: boolean = false;
    pagination: SistemaPagination;
    searchInputControl: UntypedFormControl = new UntypedFormControl();
    selectedProduct: AplicacionesProduct | null = null;
    ...
    constructor(
        ...
        private _dispositivoService: AplicacionesService,
