...
import { InstitucionesService } from 'app/modules/admin/dashboards/sistema/instituciones.service';
import {
    SistemaPagination,
...
export class InstitucionesListComponent
    implements OnInit, AfterViewInit, OnDestroy
{
    @ViewChild(MatPaginator) private _paginator: MatPaginator;
    @ViewChild(MatSort) private _sort: MatSort;
    
    products$: Observable<InstitucionesProduct[]>;
   
    flashMessage: 'success' | 'error' | null = null;
    isLoading: boolean = false;
    pagination: SistemaPagination;
    searchInputControl: UntypedFormControl = new UntypedFormControl();
    selectedProduct: InstitucionesProduct | null = null;
    ...
    constructor(
        ...
        private _dispositivoService: InstitucionesService,
