...
import { TipoDocumentoService } from 'app/modules/admin/dashboards/sistema/tipoDocumento.service';
import {
    SistemaPagination,
    TipoDocumentoProduct,
    ...
    implements OnInit, AfterViewInit, OnDestroy
{
    ...
    products$: Observable<TipoDocumentoProduct[]>;
   
    flashMessage: 'success' | 'error' | null = null;
    isLoading: boolean = false;
    pagination: SistemaPagination;
    searchInputControl: UntypedFormControl = new UntypedFormControl();
    selectedProduct: TipoDocumentoProduct | null = null;
    ...
    constructor(
        ...
        private _dispositivoService: TipoDocumentoService,
