...
import { ServiciosWebService } from 'app/modules/admin/dashboards/sistema/servicios-web.service';
import {
    SistemaPagination,
    ServiciosWebProduct,
...
@Component({
    selector: 'servicios-web',
    templateUrl: './servicios-web.component.html',
    styles: [
        ...
        `
            .registro-grid {
                ...
                @screen lg {
                    grid-template-columns: 2px 20px 75px 100px 100px auto 75px 75px 75px 100px 50px 100px;
                }
            }
        `,
    ],
...
export class ServiciosWebListComponent
    implements OnInit, AfterViewInit, OnDestroy
{
    @ViewChild(MatPaginator) private _paginator: MatPaginator;
    @ViewChild(MatSort) private _sort: MatSort;
    
    products$: Observable<ServiciosWebProduct[]>;
   
    flashMessage: 'success' | 'error' | null = null;
    isLoading: boolean = false;
    pagination: SistemaPagination;
    searchInputControl: UntypedFormControl = new UntypedFormControl();
    selectedProduct: ServiciosWebProduct | null = null;
    ...
    constructor(
        ...
        private _dispositivoService: ServiciosWebService,
    ...
    ngOnInit(): void {
        ...
        this._dispositivoService.pagination$
            ...
            .subscribe((pagination: SistemaPagination) => {
