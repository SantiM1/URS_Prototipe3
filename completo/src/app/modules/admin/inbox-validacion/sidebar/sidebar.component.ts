...
import { UserComposeComponent } from 'app/modules/admin/portal/inbox/compose/compose.component';
import { labelColorDefs } from 'app/modules/admin/portal/inbox/inbox.constants';
import { UserService } from 'app/modules/admin/portal/inbox/inbox.service';
import {
    MailFilter,
    MailFolder,
    MailLabel,
} from 'app/modules/admin/portal/inbox/inbox.types';
