...
import { SistemaComponent } from 'app/modules/admin/seguridad/sistema/sistema.component';
import { AplicacionesListComponent } from 'app/modules/admin/seguridad/sistema/aplicaciones/list/aplicaciones.component';
